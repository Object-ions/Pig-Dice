...
function rollResult1() {
  if (pigGame.currentPlayer === 1) {
    ...
    document.getElementById("player-1-temp-score").innerText = `You hit a 1! You're temporary score has reset and now it's ${player2} turn`;
    pigGame.setActivePlayer();
  } else if (pigGame.currentPlayer === 2) {
    pigGame.players[2].tempScore = 0;
    document.getElementById("display-dice-roll").innerText = 1;
    document.getElementById("player-2-temp-score").innerText = `You hit a 1! You're temporary score has reset and now it's ${player1} turn`;
    pigGame.setActivePlayer();
